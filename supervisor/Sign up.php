...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $confirmPassword) {
        ...
        $checkQuery = "SELECT id FROM users_supervisor WHERE username = '$username' OR email = '$email'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            // إدخال المستخدم
            $insertQuery = "INSERT INTO users_supervisor (fullname, email, username, password_hash)
